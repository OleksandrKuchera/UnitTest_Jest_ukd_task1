const checkLoginAndPassword = require('./task2.js')
...
test('Якщо щось буде введене невірно', () => {
    expect(checkLoginAndPassword('user1', 'BAn')).toBe('Параль або логін введено невірно');
    expect(checkLoginAndPassword('Lff', 'pass2')).toBe('Параль або логін введено невірно');
